# -*- coding: utf-8 -*-
"""
.. module:: experiments configuration
...
EXPERIMENT_YAML = os.path.dirname(__file__) + "/experiments.yml"


class Configuration(dict):
    def __init__(self, configuration_file_path=EXPERIMENT_YAML, **kwargs):
