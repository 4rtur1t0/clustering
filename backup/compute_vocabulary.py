...
paths = []
paths.append('/media/arvc/50324D7B324D6756/datasets/VIRB360/euroc/s0/0_1fps')
paths.append('/media/arvc/50324D7B324D6756/datasets/VIRB360/euroc/s0/1_1fps')

# paths.append('/media/arvc/50324D7B324D6756/datasets/VIRB360/euroc/s1/0_1fps')
# paths.append('/media/arvc/50324D7B324D6756/datasets/VIRB360/euroc/s1/1_1fps')
# paths.append('/media/arvc/50324D7B324D6756/datasets/VIRB360/euroc/s1/2_1fps')
# paths.append('/media/arvc/50324D7B324D6756/datasets/VIRB360/euroc/s1/3_1fps')

# paths.append('/media/arvc/50324D7B324D6756/datasets/VIRB360/euroc/s2/0_1fps')
# paths.append('/media/arvc/50324D7B324D6756/datasets/VIRB360/euroc/s2/1_1fps')
# paths.append('/media/arvc/50324D7B324D6756/datasets/VIRB360/euroc/s2/2_1fps')
# paths.append('/media/arvc/50324D7B324D6756/datasets/VIRB360/euroc/s2/3_1fps')
# paths.append('/media/arvc/50324D7B324D6756/datasets/VIRB360/euroc/s2/4_1fps')

# paths.append('/media/arvc/50324D7B324D6756/datasets/VIRB360/euroc/s3/0_1fps')
# paths.append('/media/arvc/50324D7B324D6756/datasets/VIRB360/euroc/s3/1_1fps')
# paths.append('/media/arvc/50324D7B324D6756/datasets/VIRB360/euroc/s3/2_1fps')
# paths.append('/media/arvc/50324D7B324D6756/datasets/VIRB360/euroc/s3/3_1fps')
...
def load_data(paths, sampling=None, max_index=None):
    all_descriptors = []
    if paths is None:
        ...
        # read several paths
        for path in paths:
            descriptors = read_descriptors(path + '/mav0/descriptors.json')
...
if __name__ == '__main__':
    ...
    # caution may be in the number of
    # 600000
    n_samples = 5000
    kw = 2
    lw = 9
    # load ORB DESCRIPTORS
    X = load_data(paths=paths, sampling=1, max_index=n_samples)
    # X = load_data(paths=None, sampling=1, max_index=n_samples)
